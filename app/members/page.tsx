...
const membersData: Member[] = [
  {
    ...
    isLeader: true,
    specialRole: "leader",
    bio: "Passionate about technology and leadership. Always ready to help classmates and lead by example.",
    skills: ["Leadership", "JavaScript", "React", "Node.js"],
    achievements: ["Class President 2024", "Best Student Award", "Programming Competition Winner"],
  ...
  },
  {
    ...
    bio: "Detail-oriented and organized. Keeps track of all class activities and documentation.",
    skills: ["Documentation", "Organization", "Python", "Data Analysis"],
    achievements: ["Perfect Attendance", "Best Documentation Award"],
    joinDate: "September 2024",
  },
  {
    id: 3,
    ...
    bio: "Responsible for managing class finances and ensuring transparency in all transactions.",
    skills: ["Financial Management", "Excel", "Accounting", "Java"],
    achievements: ["Financial Excellence Award", "Transparency Champion"],
    joinDate: "September 2024",
  },
  {
    id: 4,
    ...
    instagram: "@rama_tcp",
    image: "/placeholder.svg?height=200&width=200",
    bio: "Creative problem solver with a passion for web development and design.",
    skills: ["Web Development", "UI/UX Design", "Figma", "CSS"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Enthusiastic about mobile app development and artificial intelligence.",
    skills: ["Mobile Development", "Flutter", "AI/ML", "Python"],
    achievements: ["Mobile App Contest Winner"],
    joinDate: "September 2024",
  },
  {
    id: 6,
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Backend developer with expertise in database management and system architecture.",
    skills: ["Backend Development", "Database", "PHP", "MySQL"],
    achievements: ["System Architecture Award"],
    joinDate: "September 2024",
  },
  {
    id: 7,
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Frontend specialist who loves creating beautiful and interactive user interfaces.",
    skills: ["Frontend Development", "React", "Vue.js", "Animation"],
    achievements: ["UI Excellence Award"],
    joinDate: "September 2024",
  },
  {
    id: 8,
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Cybersecurity enthusiast focused on protecting digital assets and privacy.",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Data science enthusiast with a passion for extracting insights from complex datasets.",
    skills: ["Data Science", "Machine Learning", "R", "Statistics"],
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=200",
    bio: "Game developer who enjoys creating immersive gaming experiences.",
    skills: ["Game Development", "Unity", "C#", "3D Modeling"],
    achievements: ["Game Development Contest Winner"],
    joinDate: "September 2024",
  },
  {
    id: 11,
    ...
    instagram: "@azzamorg_",
    image: "/placeholder.svg?height=200&width=200",
    bio: "DevOps engineer passionate about automation and continuous integration.",
    skills: ["DevOps", "Docker", "Kubernetes", "CI/CD"],
    achievements: ["Automation Excellence Award"],
    joinDate: "September 2024",
  },
  {
    id: 12,
